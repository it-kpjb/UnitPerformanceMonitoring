...
@section('content')
    ...
    <div class="row align-items-center mb-4">
        <div class="col">
            ...
            <p class="text-muted mb-0">Manage and track document control statuses</p>
        </div>
        <div class="col-auto">
        ...
        <div class="col-md-12">
            <div class="card shadow-sm border-0" style="border-radius: 0.75rem; overflow: hidden;">
                <div class="card-header bg-white border-bottom-0 py-3 d-flex align-items-center justify-content-between">
                    <h5 class="card-title mb-0 font-weight-bold text-dark" style="font-size: 1.1rem;">Document List</h5>
                    ...
                    <table class="table table-hover mb-0 text-nowrap">
                        <thead class="bg-light" style="border-bottom: 2px solid #e5e7eb;">
                            <tr>
                                ...
                                <th class="text-muted font-weight-bold text-uppercase border-top-0" style="font-size: 0.75rem; padding: 1rem;">Category</th>
                        ...
                        <tbody style="border-top: none;">
                            @forelse ($docs as $doc)
                                <tr style="border-bottom: 1px solid #f3f4f6;">
                                    ...
                                    <td class="align-middle" style="padding: 1rem;">
                                        <span class="badge badge-pill badge-light text-secondary border px-2 py-1" style="font-weight: 500;">{{ $doc->category->name }}</span>
                                    </td>
                                    <td class="align-middle" style="padding: 1rem;">
                                    ...
                                    <td class="align-middle" style="padding: 1rem;">
                                        <form method="POST" action="{{ route('docsMon.updateStatus', ['id' => $doc->id]) }}" class="d-flex align-items-center" style="gap: 8px;">
                                            @csrf
                                            @method('PUT')
                                            <select name="status_id" class="form-control form-control-sm custom-select" style="width: auto; border-radius: 0.4rem; padding-right: 2rem; border-color: #e5e7eb;" onchange="this.form.submit()">
                                            ...
                                            <noscript><button type="submit" class="btn btn-sm btn-secondary">Update</button></noscript>
                                        </form>
                                    </td>
                                    <td class="align-middle" style="padding: 1rem;">
                                        <div class="dropdown">
                            ...
                            @empty
                                <tr>
                                    <td colspan="8" class="text-center py-5 text-muted">
                                        <div class="mb-3"><i class="fe fe-inbox fe-32 text-light"></i></div>
                                        <p class="mb-0">No documents found in the database.</p>
                                    </td>
                                </tr>
                            @endforelse
                        </tbody>
