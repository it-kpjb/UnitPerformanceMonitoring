                    ...
                    <div class="col-md-12">
                            <form method="POST" action="{{ route('docsMon.update', encrypt($doc->id)) }}"  enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="user" class="form-control" value="{{old ('user', $doc->user) }}" required>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control drgpicker" name="tgldoc" id="date-input1" aria-describedby="button-addon2" value="{{ old('tgldoc', \Carbon\Carbon::parse($doc->tgldoc)->format('m/d/Y')) }}" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" name="files[]" class="form-control-file" accept=".pdf,.doc,.docx" multiple>
                                </div>
