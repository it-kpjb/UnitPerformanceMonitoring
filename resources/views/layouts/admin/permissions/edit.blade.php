...
@section('content')
    <div class="row align-items-center mb-4">
        <div class="col">
            <h2 class="h3 mb-0 text-gray-800 font-weight-bold">Edit Permission</h2>
            <p class="text-muted mb-0">Update existing permission definition</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('permissions.update', $permission->id) }}">
                        ...
                        <div class="form-group mb-5">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $permission->name }}" style="border-radius: 0.5rem; border: 1px solid #e5e7eb; padding: 0.5rem 1rem;" placeholder="e.g. edit-articles" required>
                            @if ($errors->has('name'))
