...
@section('content')
    <div class="row align-items-center mb-4">
        <div class="col">
            <h2 class="h3 mb-0 text-gray-800 font-weight-bold">Edit Role</h2>
            <p class="text-muted mb-0">Update system role and refine its permissions</p>
        </div>
        <div class="col-auto">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('roles.update', $role->id) }}" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ $role->name }}" style="border-radius: 0.5rem; border: 1px solid #e5e7eb; padding: 0.5rem 1rem;" placeholder="e.g. Content Manager">
                            @if ($errors->has('name'))
