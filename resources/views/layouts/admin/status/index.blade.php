...
<div class="col-md-6 my-4">
    <button type="button" class="btn mb-2 btn-primary" data-toggle="modal" data-target="#varyModal" data-whatever="@mdo">Create Status</button>
                      ...
                      <table class="table table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <form method="POST" action="{{ route('status.destroy', $sts->id) }}" style="display:inline;">
                                @csrf
                                @method('DELETE')
